        ...
        <div className="w-11/12 max-w-7xl mx-auto text-white font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Body Paint Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                        From touch ups to scratch repair and full auto body repaints, 4M Collision provides OEM quality automotive paint services.
                    </p>
                </div>     
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Auto Body Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                ...
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Bumper Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                        Remove dents, scratches and gouges from your bumper with bumper repair by 4M Collision. Call & get an estimate today!
                    </p>
                </div>     
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Fender Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                ...
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Hail Damage Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                ...
                <div>
                    ...
                    <h3 className="text-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0">Paintless Dent Repair</h3>
                    <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">
                ...
                <div className="col-span-1 sm:col-span-2 sm:h-4/6 p-10 bg-white text-black  mx-auto border-yellow-300 lazyload transition-opacity duration-1000 ease-in-out opacity-0" style={{border: `20px solid rgb(252, 211, 77)`}}>
                <p className="lazyload transition-opacity duration-1000 ease-in-out opacity-0">If you're uncertain that we provide a service you're looking for, please reach out to us. 
                   More likely than not we will be able help you out.
                </p>
                <button className=" bg-yellow-300 before:bg-gray-800 hvr-sweep-to-right w-auto font-bold mx-auto px-4 font-sans rounded text-black hover:text-yellow-300 py-6 lazyload transition-opacity duration-1000 ease-in-out opacity-0">
